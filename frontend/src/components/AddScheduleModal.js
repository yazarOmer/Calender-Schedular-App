  ...
  return (
    <div className='w-full h-screen flex fixed top-0 left-0 bg-neutral-950/[.06] justify-center items-center'>
        <div className='w-[400px] bg-white shadow flex flex-col p-6 items-center'>
            ...
            <form onSubmit={handleCreateSchedule} className='flex flex-col justify-between w-[400px] p-6 pb-0'>
                <div className='mb-2 w-full flex items-center justify-between'>
                    <label htmlFor='text' className='font-bold mr-4'>Title</label>
                    <input name='text' value={formData.text} onChange={onChangeHandler} className='border p-2 rounded-md'/>
                </div>
                <div className='mb-2 w-full flex items-center justify-between'>
                ...
                <div className='mb-2 w-full flex items-center justify-between'>
                    ...
                    <input name='startHour' value={formData.startHour} onChange={onChangeHandler} className='border p-2 rounded-md'/>
                </div>
                <div className='mb-4 w-full flex items-center justify-between'>
                    <label htmlFor='endHour' className='font-bold mr-4'>Ending</label>
                    <input name='endHour' value={formData.endHour} onChange={onChangeHandler} className='border p-2 rounded-md'/>
                </div>
